...
parser = argparse.ArgumentParser(
    description="Approximate digits of Pi using Monte Carlo simulation.")
...
if __name__ == "__main__":
    ...
    if args.parallel:
        print("Estimating Pi using multiprocessing with {} samples...".format(
            args.num_samples))
        approximate_pi_parallel(args.num_samples)
    elif args.distributed:
        print("Estimating Pi using ray.util.multiprocessing with {} samples...".format(
            args.num_samples))
        approximate_pi_distributed(args.num_samples)
    else:
        print("Estimating Pi in one process with {} samples...".format(
            args.num_samples))
