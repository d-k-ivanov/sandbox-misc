...
clang --std=c++17 -O3 -DNDEBUG -Xclang -flto-visibility-public-std -o bin/Release/1_fixes_and_deprecations/direct_list_initialisation.exe src/1_fixes_and_deprecations/direct_list_initialisation.cpp
